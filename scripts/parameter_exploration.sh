...
then
  ...
  then
    ...
    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-fast-detection-delta/001-fast-dd-15 --frontend \
     XVIO --name "XVIO fast_dd=15" --overrides fast_detection_delta=15

    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-fast-detection-delta/002-fast-dd-20 --frontend \
...
then
  ...
  then
    ...
    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/001-ransac-px-0.2 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.2" --overrides outlier_method=8 outlier_param1=0.2 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/002-ransac-px-0.25 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.25" --overrides outlier_method=8 outlier_param1=0.25 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/003-ransac-px-0.35 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.35" --overrides outlier_method=8 outlier_param1=0.35 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/004-ransac-px-0.4 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.4" --overrides outlier_method=8 outlier_param1=0.4 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/005-ransac-px-0.45 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.45" --overrides outlier_method=8 outlier_param1=0.45 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/006-ransac-px-0.5 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.5" --overrides outlier_method=8 outlier_param1=0.5 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/007-ransac-px-0.55 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.55" --overrides outlier_method=8 outlier_param1=0.55 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/008-ransac-px-0.6 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.6" --overrides outlier_method=8 outlier_param1=0.6 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/009-ransac-px-0.65 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.65" --overrides outlier_method=8 outlier_param1=0.65 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/010-ransac-px-0.7 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.7" --overrides outlier_method=8 outlier_param1=0.7 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/011-ransac-px-0.75 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.75" --overrides outlier_method=8 outlier_param1=0.75 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/012-ransac-px-0.8 --frontend \
    #  XVIO --name "XVIO RANSAC px=0.8" --overrides outlier_method=8 outlier_param1=0.8 outlier_param2=0.99

    # python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-outlier-method/013-ransac-px-0.85 --frontend \
...
then
  ...
  then
    ...
    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/001-sigma-img-4-f --frontend \
     XVIO --name "XVIO sigma_img=4/f" --overrides sigma_img=0.02009117712909311

    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/002-sigma-img-4.25-f --frontend \
     XVIO --name "XVIO sigma_img=4.25/f" --overrides sigma_img=0.02134687569966143

    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/003-sigma-img-8.4.5-f --frontend \
     XVIO --name "XVIO sigma_img=4.5/f/f" --overrides sigma_img=0.02260257427022975

    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/004-sigma-img-4.75-f --frontend \
     XVIO --name "XVIO sigma_img=4.75/f" --overrides sigma_img=0.02385827284079807
     
    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/005-sigma-img-5.25-f --frontend \
     XVIO --name "XVIO sigma_img=5.25/f" --overrides sigma_img=0.02636966998193471
     
    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/006-sigma-img-5.5-f --frontend \
     XVIO --name "XVIO sigma_img=5.5/f" --overrides sigma_img=0.027625368552503027
     
    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/007-sigma-img-5.75-f --frontend \
     XVIO --name "XVIO sigma_img=5.75/f" --overrides sigma_img=0.028881067123071345
     
    python evaluate.py --configuration $CONFIGURATION --output_folder $1/$DATE-xvio-sigma-img/008-sigma-img-6-f --frontend \
