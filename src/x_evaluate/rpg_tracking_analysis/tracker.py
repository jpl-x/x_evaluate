...
class Tracker:
    ...
    def track_features_on_klt(self, tracks_obj, tracker_params):
        ...
        print("Tracking with KLT parameters: [window_size=%s num_pyramidal_layers=%s]" % (
        window_size, num_pyramidal_layers))
    ...
    def track_features_with_landmarks(self, tracks_obj, tracker_params):
        ...
        for i, (t, pose) in enumerate(tqdm.tqdm(pose_dataset)):
            ...
            new_features = project_landmarks(active_landmarks, pose, K)
